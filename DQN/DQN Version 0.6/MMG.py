...
#         temp1 = activate(data1[-1],0.61,12.05)
#     elif j > 29:
#         temp1 = activate(data1[-1],0,12.05)
...
# # plt.plot([0,30],[0,-30])
# plt.plot(x1,y1,'purple',marker="*",label = " Counter Clockwise Test ")
# plt.plot(x2,y2,'green',marker="*",label = " Clockwise Test ")
