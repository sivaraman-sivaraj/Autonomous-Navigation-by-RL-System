...
# wp,x_path,y_path,L       = waypoints.Sigmoidal_curve()
...
register(id ='NavigationRL-v0', entry_point='Environment.Env:load',kwargs={'wpA' : wpA, 'u': initial_velocity, 'wp': wp,'rps' : rps})
###################################################
################## DQN Training ###################
###################################################
