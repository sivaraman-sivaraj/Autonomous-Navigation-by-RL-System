...
class load(Env): # NavigationRL-v0
     ...
     def __init__(self,wp,wpA,u,rps):
     ...
     def reset(self):
        #######################
        ## H = [last quadrant, last waypoint,goal]
        ########################
     ...
     def step(self,C):
         ...
         self.reward_a                        = Reward.get(self.ip, self.op,self.y_e,self.HE,self.goal)
         #################################
         ###### Next State Update ########
         #################################
         self.op[6]              = self.HE
     ...
     def render(self,mode='human'):
         ...
         tp      : Trajectory Points, (optional)
         
         ----------------
         description
         ----------------
         Scale : (grid_size/600) = scaling ratio
         (optional), need to change depends on the span if waypoints
         """
         screen_width     = 600
         screen_height    = 600
