...
# prp,x,y,L = waypoints.Fibbanaci_Trajectory(35)
# prp,x,y,L = waypoints.cardioid(100)
# prp,x,y,L = waypoints.parametric(110)
# L = 0
...
plt.xlabel("Advance")
plt.ylabel("Transfer")
plt.scatter(0,0,marker="s",color="m")
# plt.annotate("Starting and End Point",xy=(0,0),xytext=(120, -120),arrowprops=dict(facecolor='black', shrink=0.05))
plt.axvline(x=0,color='y',alpha=0.8)
plt.axhline(y=0,color='y',alpha=0.8)
plt.title("LOS Evaluation by PID controller for Open Loop Circle Trajectory")
# plt.grid()
plt.legend(loc="best")
plt.show()
